...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.RBBaidu = QtWidgets.QRadioButton(self.centralwidget)
        self.RBBaidu.setStyleSheet("font: 87 10pt \"Arial Black\";")
        self.RBBaidu.setObjectName("RBBaidu")
        self.gridLayout.addWidget(self.RBBaidu, 2, 1, 1, 1)
...
"background-color: rgb(255, 131, 131);")
        ...
        self.gridLayout.addWidget(self.PBTranslate, 5, 0, 1, 4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RBBaidu.setText(_translate("MainWindow", "Baidu"))
